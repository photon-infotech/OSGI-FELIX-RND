...
public class HelloWorldResource {
    ...
    public Response gettest() {
    	...
    	temp.setPassword("dsaf");
    	return Response.status(Status.OK).entity(temp).header(
    ...
    public Response gettest2(Credentials temp) {
    	System.out.println("Reached the server");
    	return Response.status(Status.OK).entity("success").header(
				"Access-Control-Allow-Origin", "*").build();
    }
}